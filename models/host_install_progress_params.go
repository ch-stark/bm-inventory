...
type HostInstallProgressParams struct {
	...
	// current step
	// Required: true
	CurrentStep HostStep `json:"current_step"`
...
func (m *HostInstallProgressParams) validateCurrentStep(formats strfmt.Registry) error {

	if err := m.CurrentStep.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("current_step")
		}
		return err
	}
